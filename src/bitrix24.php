...
use Bitrix24\Exceptions\Bitrix24PropertyNotFoundException;
use Bitrix24\Exceptions\Bitrix24QueryLimitExceededException;
...
<<<<<<< HEAD
     ...
     * @throws Bitrix24MethodNotFoundException
     * @throws Bitrix24PaymentRequiredException
     * @throws Bitrix24PropertyNotFoundException
     * @throws Bitrix24QueryLimitExceededException
     * @throws Bitrix24TokenIsExpiredException
     * @throws Bitrix24TokenIsInvalidException
     * @throws Bitrix24WrongClientException
=======
        ...
        if (array_key_exists('error', $arRequestResult)) {
            ...
            switch (strtoupper(trim($arRequestResult['error']))) {
                ...
                case 'ERROR_ENTITY_NOT_FOUND':
                    throw new Bitrix24EntityNotFoundException($errorMsg);
                case 'ERROR_PROPERTY_NOT_FOUND':
                    throw new Bitrix24PropertyNotFoundException($errorMsg);
                case 'QUERY_LIMIT_EXCEEDED':
                    throw new Bitrix24QueryLimitExceededException($errorMsg);
                default:
