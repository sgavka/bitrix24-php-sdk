...
class Event
{
    ...
    const ON_CRM_INVOICE_ADD = 'ONCRMINVOICEADD';
    const ON_CRM_INVOICE_UPDATE = 'ONCRMINVOICEUPDATE';
    const ON_CRM_INVOICE_DELETE = 'ONCRMINVOICEDELETE';
    const ON_CRM_INVOICE_SET_STATUS = 'ONCRMINVOICESETSTATUS';
}
